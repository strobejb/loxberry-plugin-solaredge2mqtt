...
grep -q -F "LOCALTIME=" $ARGV5/config/plugins/$ARGV3/se2mqtt.cfg || echo "LOCALTIME=0" >> $ARGV5/config/plugins/$ARGV3/se2mqtt.cfg 
...
$PIP3 install --user --upgrade solaredge
$PIP3 pip install --user --upgrade paho-mqtt
